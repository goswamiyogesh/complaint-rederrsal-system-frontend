...
export class EngineersService {
  ...
  private regEngineerUrl: string =
    'http://localhost:8089/engineers/addEngineer';
  private logEngineerUrl: string = 'http://localhost:8089/engineers/login';
  private getAllEngineerMailsUrl: string =
    'http://localhost:8089/engineers/getAllEngineerMails';

  private getAllComplaintsByTicketIdUrl: string =
    'http://localhost:8089/complaints/getAllComplaintsByTicketIds';
  private updateStatusUrl: string =
    'http://localhost:8089/engineerDuty/updateStatus';

...
export class ManagersService {
  ...
  private regManagerUrl: string = 'http://localhost:8089/managers/addManager';

  private logManagerUrl: string = 'http://localhost:8089/managers/login';

  private getAllComplaintsByPincodeUrl =
    'http://localhost:8089/managers/getAllComplaintsByPincode';

  private assignEngineersDutyUrl =
    'http://localhost:8089/engineerDuty/addEngineerDuty';
